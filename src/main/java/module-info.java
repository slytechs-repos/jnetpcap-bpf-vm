 ...
 * </ul>
 * 
 * @provides com.slytechs.jnet.jnetruntime.bpf.vm.api.BpfExtension Extension
 *           point for adding custom BPF functionality
 * 
 * @uses com.slytechs.jnet.jnetruntime.bpf.vm.api.BpfExtension Service interface
 *       for BPF extensions
 * 
 * @see com.slytechs.jnet.jnetruntime.bpf.vm.core.BpfVirtualMachine
 * @see com.slytechs.jnet.jnetruntime.bpf.vm.core.BpfProgram
 * @see com.slytechs.jnet.jnetruntime.bpf.vm.instruction.BpfOpcode
 * 
 * @author Sly Technologies Inc
 * @version 1.0
 */
module com.slytechs.jnet.jnetruntime.bpf.vm {
	 ...
	 * tools.
	 */
	exports com.slytechs.jnet.jnetruntime.bpf.vm.tools to
	 ...
	 */
	opens com.slytechs.jnet.jnetruntime.bpf.vm.core to
	 ...
	 */
	uses com.slytechs.jnet.jnetruntime.bpf.vm.api.BpfExtension;
	 ...
	 */
	provides com.slytechs.jnet.jnetruntime.bpf.vm.api.BpfExtension with
			com.slytechs.jnet.jnetruntime.bpf.vm.core.DefaultBpfExtension;
}